...
The data is skewed to the right. Because the highest counts are higher than the mean, the data has a skew to the right and is not normal. The majority of the data falls in between 8 and 17, with 21 out of 31 days falling in that range. 
